 ...
 */
final class Version20200505043222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE suggestions ADD validation TINYINT(1) NOT NULL, CHANGE question_id question_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE examen_id examen_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reponses_etudiant CHANGE examen_id examen_id INT DEFAULT NULL, CHANGE question_id question_id INT DEFAULT NULL, CHANGE suggestions_id suggestions_id INT DEFAULT NULL, CHANGE etudiant_id etudiant_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE suggestions DROP validation, CHANGE question_id question_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user CHANGE classe_id classe_id INT DEFAULT NULL, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`');
    }
}
